    ...
    return (
            <div className="options">
                <div className="banlist-select-container">
                    <select 
                        value={banlistType} 
                        onChange={(e) => dispatch({type: 'SET_BANLIST_TYPE', payload: e.target.value})}
                ...
                <button 
                    ...
                    style={{ background: isUnlimited ? '#d32f2f' : 'linear-gradient(311deg, rgba(0,98,157,1) 25%, rgba(18,124,67,1) 77%)' }}
                >
